...
#show: post.with(
  title: "KMP 算法",
  pub-date: datetime(year: 2023, month: 3, day: 8),
  mod-date: datetime(year: 2023, month: 3, day: 8),
)
...
推荐 KMP 算法讲解视频：#link("https://www.bilibili.com/video/BV1AY4y157yL")[最浅显易懂的 KMP 算法讲解]
